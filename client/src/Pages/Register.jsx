       ...
       {showOtpInput && (
        <div className="fixed z-20 inset-0 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
          <div className="relative w-auto max-w-3xl mx-auto my-6">
            <div className="relative flex flex-col w-full animated-background  bg-gradient-to-r from-blue-300 via-blue-600 to-indigo-400   mx-auto py-8 border-0 rounded-lg shadow-lg outline-none focus:outline-none">
              <div className="relative p-6 flex-auto">
                <form onSubmit={handleOtpVerification} className="flex flex-col justify-center items-center">
                  <h1 className="text-xl font-bold font-itim leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                    Verify OTP
                  </h1>
                  <p className="font-semibold text-red-900 ">Check Your Inbox</p>
                  <div className="mt-4">
                    <label
                      htmlFor="otp"
                  ...
                  <div className="mt-6 text-right">
                    <button
                      type="submit"
                      className="text-white font-itim bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-lg px-5 py-2.5 text-sm"
                    >
                      Verify OTP
                    </button>
                  </div>
