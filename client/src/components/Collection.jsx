...
function Collection() {
  return (
    ...
    <div className="p-3">
      <div className="container bg-slate-800 rounded-3xl m-10 mx-auto py-8">
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          <div className="col-span-4 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-3">
              <div className="flex flex-col items-center">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRY2reAyRUbEOfvgWkva6jlWBkwkTvfB0vfAw&s" className="w-32 h-32 bg-gray-300 rounded-full mb-2 shrink-0" alt="John Doe" />
                <h1 className="text-xl font-bold">Satyam Mittal</h1>
                <p className="text-gray-700">Investor</p>
              ...
              <div className="flex flex-col">
                <span className="text-gray-700 w-full text-center uppercase font-bold tracking-wider">Find Me At</span>
              <div className="flex justify-center items-center gap-6 my-4">
                <a className="text-gray-700 hover:text-sky-600" aria-label="Visit TrendyMinds LinkedIn" href="" target="_blank">
                ...
                <a className="text-gray-700 hover:text-blue-500" aria-label="Visit TrendyMinds Facebook" href="" target="_blank">
                ...
                <a className="text-gray-700 hover:text-indigo-300" aria-label="Visit TrendyMinds Instagram" href="" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                ...
                <a className="text-gray-700 hover:text-indigo-400" aria-label="Visit TrendyMinds Twitter" href="" target="_blank">
          ...
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-slate-500 shadow rounded-lg max-h-96 overflow-y-auto p-6">
      ...
      <div className="container bg-slate-800 rounded-3xl m-10 mx-auto py-8">
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          ...
          <div className="col-span-4 sm:col-span-9 ">
            <div className="bg-slate-500 shadow rounded-lg max-h-96 overflow-y-auto  p-6">
                <h1 className='font-itim text-xl text-white'>Latest Posts</h1>
                <div className='bg-white p-2 my-4 rounded-lg'>
            <h2 className="text-xl  font-bold mt-6 mb-4">Topic</h2>
              <div className="mb-6">
                <div className="flex justify-between flex-wrap gap-2 w-full">
